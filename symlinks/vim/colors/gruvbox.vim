...
" }}}
" Custom Statusline: {{{
call s:HL('ModeInsert', s:yellow, s:bg2, s:bold)
call s:HL('ModeVisual', s:green, s:bg2, s:bold)
call s:HL('StatusLineGreenBg', s:fg1, s:green)
call s:HL('StatusLineYellowBg', s:fg1, s:yellow)
call s:HL('StatusLineRedBg', s:fg1, s:red)
call s:HL('StatusLineBlueBg', s:fg1, s:blue)
call s:HL('StatusLineGreenFg', s:green, s:bg2, s:bold)
call s:HL('StatusLineYellowFg', s:yellow, s:bg2, s:bold)
call s:HL('StatusLineRedFg', s:red, s:bg2, s:bold)
call s:HL('StatusLineBlueFg', s:blue, s:bg2, s:bold)
call s:HL('StatusLinePurpleFg', s:purple, s:bg2, s:bold)
hi! link StatusError GruvboxRedBold
hi! link StatusWarning GruvboxYellowBold
" }}}
